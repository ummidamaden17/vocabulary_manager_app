...
class FourthCoursePage extends StatefulWidget {
  @override
  _FourthCoursePageState createState() => _FourthCoursePageState();
}

class _FourthCoursePageState extends State<FourthCoursePage> {
  List<Word> words = [];
  ...
  Future<void> loadWords() async {
    try {
      final String response = await rootBundle.rootBundle
          .loadString('assets/fourthCourse_words.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fourth Course Words'),
        actions: [
          IconButton(
  ...
  Future<void> saveWordToCategory(BuildContext context, Word word) async {
    ...
    ('Saved words after: ${prefs.getStringList('saved_words')}');
  }
}
